...
\begin{docCommand}[doc new and updated={2016-07-01}{2023-12-18}]{ifcsvstrcmp}{\marg{stringA}\marg{stringB}\marg{true}\marg{false}}
...
\begin{docCommand}[doc new and updated={2016-07-01}{2023-12-18}]{ifcsvstrequal}{\marg{stringA}\marg{stringB}\marg{true}\marg{false}}
  Compares two strings (token lists in expl3 syntax) and executes \meta{true} if they are equal, and \meta{false} otherwise.
  The strings are expanded and the comparison is done using |\tl_if_eq:eeTF|.

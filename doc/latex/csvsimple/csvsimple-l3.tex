...
\begin{docCommands}{
  ...
  but \refCom{thecsvrow} being an accessor of the \LaTeX3 integer
...
\begin{docCommands}[doc new=2021-06-25]{
  ...
  but \refCom{thecsvcolumncount} being an accessor of the \LaTeX3 integer
...
\begin{docCommands}{
  ...
  but \refCom{thecsvinputline} being an accessor of the \LaTeX3 integer
